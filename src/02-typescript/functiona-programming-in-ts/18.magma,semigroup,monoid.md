---
tags: [typescript, functional-programming, algebraic-structures, magma, semigroup, monoid]
...
> [!important] Практическая ценность `Monoid`
> `Monoid` особенно полезен там, где нужен начальный accumulator: `reduce`, агрегация логов, сбор ошибок, объединение конфигов, конкатенация списков.
