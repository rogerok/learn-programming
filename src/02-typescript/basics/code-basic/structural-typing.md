---
tags: [typescript, structural-typing, duck-typing]
aliases: [Структурная типизация]
---
...
Объект совместим, потому что `typeof moderator` требует все поля `User` и дополнительное поле `email`: множество значений `typeof moderator` является подмножеством множества `User`.
