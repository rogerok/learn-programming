...
function test(description, actual, expected) {
  const actualVal = actual instanceof Container ? actual._value : actual;
  const expectedVal = expected instanceof Container ? expected._value : expected;
...
function testInstance(description, actual, expectedClass) {
