...
> [!info] Контекст
> Это приоритизированный каталог внешнего чтения, а не доказательство progression. Актуальный учебный цикл и следующий проверяемый шаг находятся в [[../00-learning/MOC|Learning System]].
