---
tags: [react, advanced, elements, children, rerenders]
---

# Elements, Children as Props, and Re-renders

> [!info] Context
> Оптимизация через вынос children и elements as props. React elements vs components.
> Пререквизит: [[1.rerenders|Глава 1 — rerenders]]
