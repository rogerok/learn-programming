---
tags: [react, advanced, closures, state]
---

# Understanding Closures and Stale References in React

> [!info] Context
> Проблема устаревших замыканий в React: stale closures с React.memo, useCallback, useRef.
> Пререквизиты: [[5.Memoization with useMemo, useCallback and React.memo|Глава 5 — мемоизация]], [[../../01-javascript/core/functions/closure|JS замыкания]]
