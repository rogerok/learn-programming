---
tags: [react, advanced, render-props]
---

# Advanced React Patterns: Configuration with Render Props

> [!info] Context
> Render props как альтернатива cloneElement для гибкой конфигурации.
> Пререквизит: [[3.Configuration concerns with elements as props|Глава 3 — elements as props configuration]]
