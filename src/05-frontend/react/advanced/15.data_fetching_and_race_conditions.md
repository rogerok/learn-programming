---
tags: [react, advanced, data-fetching, race-conditions]
---

# Data Fetching and Race Conditions

> [!info] Context
> Race conditions при data fetching: почему возникают и как решать (cleanup, AbortController, useRef).
> Пререквизиты: [[14.data_fetching_client_performance|Глава 14 — data fetching]], Promises, useEffect, useRef, AbortController
