---
tags: [react, advanced, configuration, elements]
---

# Configuration Concerns with Elements as Props

> [!info] Context
> Конфигурация компонентов через elements as props и `React.cloneElement`.
> Пререквизит: [[2.elements,children as props, and re-renders|Глава 2 — elements as props]]
...
```jsx
const Button = ({sudo apt install libsecret-1-0 libsecret-1-dev make gcc
