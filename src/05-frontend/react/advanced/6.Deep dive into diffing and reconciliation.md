---
tags: [react, advanced, diffing, reconciliation, virtual-dom]
---

# Deep Dive into Diffing and Reconciliation

> [!info] Context
> Как React сравнивает Virtual DOM деревья, роль `key`, mount/unmount циклы.
> Пререквизиты: [[2.elements,children as props, and re-renders|Глава 2 — elements vs components]], useState
