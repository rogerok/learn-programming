---
tags: [react, advanced, rerenders, performance]
---

# Optimizing React Rerenders

> [!info] Context
> Как и почему React перерисовывает компоненты. Фундамент для всех последующих глав.
> Пререквизиты: базовый React (компоненты, props, useState)
