---
tags: [react, advanced, data-fetching, performance]
---

# Data Fetching on the Client and Performance

> [!info] Context
> Request waterfalls, параллелизация запросов, Promise.all, проблемы с useEffect + fetch.
> Пререквизиты: useEffect, useState, JavaScript Promises, React Context API
...
Pay special attention to the 6th line there. What is `fetch('/get-comments')`? It's nothing more than just a promise that we await
