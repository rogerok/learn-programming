---
tags: [react, advanced, memoization, useMemo, useCallback]
---

# Memoization in React: Optimizing Component Re-Renders

> [!info] Context
> useMemo, useCallback, React.memo — когда и зачем мемоизировать.
> Пререквизиты: [[1.rerenders|Глава 1 — rerenders]], [[2.elements,children as props, and re-renders|Глава 2 — elements as props]], referential equality в JS
