...
> [!info] Контекст
> Раздел 3.3 связывает C-типы с машинными размерами данных в `x86-64`: byte, word, double word, quad word. Это нужно, чтобы читать инструкции из [[../3.2/3.2-overview|3.2 --- Программный код]]. Следующий раздел 3.4 «Доступ к информации» пока недоступен в vault.
>
